...
<head>
  ...
  <title>Upâyâ Café | Premium Matcha Series</title>
  ...
  <div class="menu-section">
    ...
    <div class="product-grid" id="product-grid">
      ...
      <div class="items">
        ...
        <div class="item" data-name="Salted Matcha Latte" data-price="165">Dirty Matcha Latte - 165</div>
        <div class="item" data-name="Salted Matcha Latte" data-price="160">White Choco Matcha Latte - 160</div>
        <div class="item" data-name="Salted Matcha Latte" data-price="160">Peach Matcha Latte - 160</div>
        <div class="item" data-name="Salted Matcha Latte" data-price="160">Peach Mango Matcha Latte - 160</div>
        <div class="item" data-name="Salted Matcha Latte" data-price="160">Hazelnut Matcha Latte - 160</div>
        <div class="item" data-name="Salted Matcha Latte" data-price="170">Biscoff Matcha Latte - 170</div>
       <!-- Add more items... -->
      </div>
    </div>
  </div>
